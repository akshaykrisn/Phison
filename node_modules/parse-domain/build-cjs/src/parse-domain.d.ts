import { ValidationError, SanitizationResultValidIp, Validation } from "./sanitize";
...
export declare type ParseDomainOptions = {
    /**
 ...
 */
export declare const parseDomain: (hostname: string | typeof NO_HOSTNAME, options?: ParseDomainOptions | undefined) => ParseResult;
export {};
